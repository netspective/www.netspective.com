  ...
  return (
    <form id="quickcontact" onSubmit={(event: React.FormEvent<HTMLFormElement>) => handleSubmitForm(event)}>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2">
              ...
              <div className="mr-3 ml-3">
                <div className="mb-3">
                  <textarea id="contactMessage" name="message"  rows={4} placeholder=" Message" className="block w-full rounded-md border-0 px-3 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                </div>
                <button type="submit" id="contactSubmit" className="rounded-md bg-sky-700 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-sky-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Send message</button>
                {isSubmitted && (
